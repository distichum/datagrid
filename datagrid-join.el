...
(defun datagrid-join (datagrid1 join-on-1 datagrid2 join-on-2 &rest dg2-indices)
  "Left join DATAGRID2 onto DATAGRID1, keeping DG2-INDICES columns.
Rows are matched by comparing the JOIN-ON-1 column of DATAGRID1
with the JOIN-ON-2 column of DATAGRID2.
